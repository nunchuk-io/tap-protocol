...
void memory_cleanse(void *ptr, size_t len) {
   ...
   * implement the memset() efficiently, just not remove it entirely. See "Dead
   * Store Elimination (Still) Considered Harmful" by Yang et al. (USENIX
   * Security 2017) for more background.
   */
